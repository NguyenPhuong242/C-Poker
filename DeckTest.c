...
{
  Deck d;
  Deck_initFromPips(&d, "2c 3d 4h 5s");
...
{
  Deck d;
  Deck_initFromPips(&d, "8c 4s 7c 3s");
...
{
  Deck d;
  Deck_initFromPips(&d, "8c 4d 8h 4s");
...
{
  Deck d1;
  Deck_initFromPips(&d1, "2c 3d 4h 5s");
  Deck d2;
  Deck_initFromPips(&d2, "Ah");
